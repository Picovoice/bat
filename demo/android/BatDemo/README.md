...
Replace `"${YOUR_ACCESS_KEY_HERE}"` inside [MainActivity.java](bat-demo-app/src/main/java/ai/picovoice/batdemo/MainActivity.java)
...
2. Start talking. The language scores will appear in the layout above.
