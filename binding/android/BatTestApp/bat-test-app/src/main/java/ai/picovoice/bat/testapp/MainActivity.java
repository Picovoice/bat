...
public class MainActivity extends AppCompatActivity {
    ...
    public void runTest() {
        ...
        try {
            ...
            result.errorMessage = String.format("Failed to init bat with '%s'", e);
        } finally {
            results.add(result);
        }
        ...
        try {
            ...
            HashMap<BatLanguages, Float> processResult = processTestAudio(bat, audioPath);
    ...
    private String getModelFile() {
        return "models/bat_params.pv";
    }

    private HashMap<BatLanguages, Float> processTestAudio(@NonNull Bat c, String audioPath) throws Exception {
